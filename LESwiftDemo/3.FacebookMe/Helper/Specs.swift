...
public struct Specs {
    ...
    public struct FontSize {
        public let tiny : CGFloat = 10.0
        public let small : CGFloat = 12.0
        public let regular : CGFloat = 14.0
        public let large : CGFloat = 16.0
    }
    ...
    public struct Font {
        ...
        public let smalBold = UIFont(name: boldName, size: Specs.fontSize.small)
